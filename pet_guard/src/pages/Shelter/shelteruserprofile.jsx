...
//   return (
//     <div className="min-h-screen bg-[#F3F1EE] py-12 px-4">
//       <div className="max-w-3xl mx-auto space-y-6">
        
//         {/* Back Button */}
//         <button 
//           onClick={() => navigate(-1)} 
//           className="flex items-center gap-2 text-slate-600 hover:text-[#183D8B] font-bold transition-all group mb-4"
//         >
...
//         <div className="bg-white rounded-3xl shadow-[0_15px_35px_-5px_rgba(0,0,0,0.08)] border-2 border-white overflow-hidden">
...
//             ) : (
//               <div className="flex items-center gap-4">
//                 <button onClick={handleCancel} className="text-white/80 hover:text-white text-sm font-semibold transition-colors">
//                   Discard
//                 </button>
//                 <button 
...
//                     className="w-full pl-5 pr-12 py-3 text-sm font-medium rounded-xl border-2 border-slate-200 focus:border-[#183D8B] focus:shadow-[0_4px_20px_rgba(24,61,139,0.08)] transition-all outline-none"
//                   />
//                   <button 
//                     type="button"
...
// export default Shelteruserprofile;
...
const Shelteruserprofile = () => {
  ...
  return (
    <ShelterLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        {/* Section: Profile Information */}
        <div className="bg-white rounded-3xl shadow-[0_15px_35px_-5px_rgba(0,0,0,0.05)] border border-slate-100 overflow-hidden">
          <div className="px-8 py-6 bg-[#183D8B] flex justify-between items-center shadow-lg">
            <div className="flex items-center gap-4">
              <div className="p-2.5 bg-white/10 rounded-xl backdrop-blur-md border border-white/20">
                <FaUser className="text-white text-xl" />
            ...
            {!isEditing ? (
              ...
              <div className="flex items-center gap-4">
                <button onClick={handleCancel} className="text-black/80 hover:text-blue text-sm font-semibold transition-colors">
                  Discard
                </button>
                <button 
                  onClick={handleProfileUpdate}
        ...
        <p className="text-center text-slate-400 text-[11px] font-medium tracking-wide pb-4">
          Your data is encrypted and stored securely.
        </p>
      </div>
    </ShelterLayout>
