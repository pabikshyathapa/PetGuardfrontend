...
//               Stay updated with your latest shelter activity
//             </p>
//           </div>
...
//               No new reviews or notifications at the moment.
//             </p>
//           </div>
//         ) : (
          ...
          <div className="flex items-center gap-4">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-full hover:bg-blue-700 transition"
              >
                Mark all as read
              </button>
            )}
