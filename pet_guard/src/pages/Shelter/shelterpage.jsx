            ...
            <button
              className={`px-6 py-2 rounded-lg font-semibold transition-all shadow-sm ${
                editMode 
                  ...
                  : "bg-[#183D8B] text-white hover:bg-[#122e6b] shadow-blue-200"
              }`}
            ...
            {editMode && (
              <div className="flex justify-end pt-4">
                <button
                  ...
                  className="w-full md:w-auto bg-[#183D8B] text-white px-12 py-4 rounded-xl font-bold shadow-lg shadow-blue-200 hover:bg-[#122e6b] transform hover:-translate-y-1 transition-all"
                >
                  Save Changes
                </button>
              </div>
